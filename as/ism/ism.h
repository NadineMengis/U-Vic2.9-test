     ...
     &,isb             !cross-reference array from ASCII to ice sheet basins
      ...
      integer     
     &gprecmon         !monthly precip accumulator
     &,gtempmon        !monthly SAT accumulator
     &,year_accum      !monthly accumulator count
#endif   
...
#if defined O_ism_pdd     
     &,gprecmon(imt,jmt,12),gtempmon(imt,jmt,12)
     &,year_accum(12)
#endif  

#if defined O_mon_islapse
      common /ism_couple_r/ rlapseGIS
#endif   
