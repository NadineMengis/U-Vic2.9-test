! source file: /net/mare/home1/eby/as/updates/embm_tsi.F
...
!-----------------------------------------------------------------------
     ...
     &,   'F', 'maximum atmosphere solver iterations', ' ','')
      call defvar ('L_snovol', iou, 1, id, c0, c1e20, ' '
     ...
     &,   'F', 'SH average evaporation', ' ','kg m-2 s-1')
      call defvar ('L_snovolN', iou, 1, id, c0, c1e20
     &,   ' ', 'F', 'NH snow volume', ' ', 'm3')
      call defvar ('L_snovolS', iou, 1, id, c0, c1e20
     &,   ' ', 'F', 'SH snow volume', ' ', 'm3')
     ...
     &,  c1e20, ' ', 'F', 'SH land ice volume', ' ', 'm3')
      call defvar ('L_icesmbN', iou, 1, id, c0
     &,  c1e20, ' ', 'F', 'NH land ice smb', ' ', 'kg')
      call defvar ('L_icesmbS', iou, 1, id, c0
     &,  c1e20, ' ', 'F', 'SH land ice smb', ' ', 'kg')
     ...
     &,  c1e20, ' ', 'F', 'SH land ice area', ' ', 'm2')
      call defvar ('L_meltextentN', iou, 1, id, c0
     &,  c1e20, ' ', 'F', 'NH melt extent', ' ', 'm2')
      call defvar ('L_meltextentS', iou, 1, id, c0
     &,  c1e20, ' ', 'F', 'SH melt extent', ' ', 'm2')
      call defvar ('L_meltmassS', iou, 1, id, c0
     &,  c1e20, ' ', 'F', 'SH melt volume', ' ', 'kg')
      call defvar ('L_meltmassN', iou, 1, id, c0
     &,  c1e20, ' ', 'F', 'NH melt volume', ' ', 'kg')
      call defvar ('L_accummassS', iou, 1, id, c0
     &,  c1e20, ' ', 'F', 'SH accumulation volume', ' ', 'kg')
      call defvar ('L_accummassN', iou, 1, id, c0
     &,  c1e20, ' ', 'F', 'NH accumulation volume', ' ', 'kg')
      call defvar ('zclim', iou, 1, id, c0
     &,  c1e20, ' ', 'F', 'zclim', ' ', '')
      call defvar ('ism_sealev', iou, 1, id, c0
     &,  c1e20, ' ', 'F', 'ism_sealev', ' ', '')
...
!-----------------------------------------------------------------------
     ...
     &,                        outlwr, dnswr, inswr, netrad, palb, aalb
     &,                        salb, lsalb, osalb, sst, sss, ssdic
     &,                        ssc14, ssalk, sso2, sspo4, ssno3, sscfc11
     &,                        sscfc12, sulph, volc, agg, catm
...
!=======================================================================
      ...
      real oprecip, levap, oevap, avgper, solins, outlwr, dnswr, inswr
      real netrad, palb, aalb, salb, lsalb, osalb, sst, sss, ssdic
      real ssc14, ssalk, sso2, sspo4, ssno3, sscfc11, sscfc12, sulph
      real isvol, nisvol, sisvol, nissmb, sissmb,nisiar,sisiar
      real nismext,sismext
      real nisaccum,sisaccum,nismelt,sismelt
      real zclim_out,sealev_out
      real volc, agg, catm, time, tmp, c0, c1, c100, c1e3, c1e4, c1e6
      real p1, p001, p035, cal2J, C2K
...
!-----------------------------------------------------------------------
      ...
      call putvars ('L_snovol', iou, ntrec, v_snow, c1e6, c0)
      call putvars ('L_icevol', iou, ntrec, isvol, c1, c0)
      call putvars ('L_icearea',iou,ntrec,(nisiar+sisiar),c1,c0)
      ...
      call putvars ('L_snovolN', iou, ntrec, v_nsnow, c1e6, c0)
      call putvars ('L_snovolS', iou, ntrec, v_ssnow, c1e6, c0)
      call putvars ('L_icevolN', iou, ntrec, nisvol, c1, c0)
      call putvars ('L_icevolS', iou, ntrec, sisvol, c1, c0)
      call putvars ('L_icesmbN', iou, ntrec, nissmb, 1./913., c0)
      call putvars ('L_icesmbS', iou, ntrec, sissmb, 1./913., c0)
      call putvars ('L_iceareaN', iou, ntrec, nisiar, c1, c0)
      call putvars ('L_iceareaS', iou, ntrec, sisiar, c1, c0)
      call putvars ('L_meltextentN', iou, ntrec, nismext, c1, c0)
      call putvars ('L_meltextentS', iou, ntrec, sismext, c1, c0)
      call putvars ('L_meltmassS', iou, ntrec, sismelt, 1./913., c0)
      call putvars ('L_meltmassN', iou, ntrec, nismelt, 1./913., c0)
      call putvars ('L_accummassS', iou, ntrec, sisaccum, 1./913., c0)
      call putvars ('L_accummassN', iou, ntrec, nisaccum, 1./913., c0)
      call putvars ('zclim', iou, ntrec, zclim_out, c1, c0)
      call putvars ('ism_sealev', iou, ntrec, sealev_out, c1, c0)
      ...
      call putvars ('F_inswr', iou, ntrec, inswr, c1e3, c0)
      ...
      call putvars ('O_o2sur', iou, ntrec, ssalk, c1, c0)
