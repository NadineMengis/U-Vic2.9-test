! source file: /net/mare/home1/eby/as/updates/csbc.h
!======================= include file "csbc.h" =========================
...
!     dtoic       = total system carbon lost minus carbon gained
     ...
     &                  + 1
     &                  + 1
     &                  + 1)!for separation of isca(l/o)

      integer itaux, itauy, iws, iaca, ihflx, isflx, isst, isss
      ...
      integer iscal, iscao
      integer ibia, i1800obs

      common /csbc_i/ itaux, itauy, iws, iaca, ihflx, isflx, isst
      ...
      common /csbc_i/ iscal, iscao
      common /csbc_i/ ibia, i1800obs
      ...
      real dtatm, dtlnd, dtocn, dtsed, dtsedyr, atatm
      real atism, atlnd, atocn, atsed
      common /csbc_r/ dtatm, dtlnd, dtocn, dtsed
