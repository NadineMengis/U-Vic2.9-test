! source file: /net/mare/home1/eby/as/updates/file_names.F
...
!       read file name changes from filenames
      ...
      call put_names ('wy_', 'data/wind_adv_')
      call put_names ('wx_', 'data/wind_adv_')
      call put_names ('wa_', 'data/wind_surf_')
      call put_names ('ws_', 'data/wind_surf_')
      call put_names ('tauy_', 'data/wind_stress_')
      call put_names ('taux_', 'data/wind_stress_')
      call put_names ('sst_', 'data/sst_')
      call put_names ('sss_', 'data/sss_')
      call put_names ('rivers', 'data/rivers')
      call put_names ('kmt', 'data/kmt')
      call put_names ('region_masks', 'data/region_masks')
      call put_names ('sf_alb', 'data/sf_alb')
      call put_names ('a_calb', 'data/a_calb')
      call put_names ('hflx', 'data/hflx')
      call put_names ('sflx', 'data/sflx')
      call put_names ('grid', 'data/grid')
      call put_names ('elev', 'data/elev')
      call put_names ('tbar', 'data/tbar')
      call put_names ('veg', 'data/veg')
      call put_names ('solar', 'data/solar')
      call put_names ('co2', 'data/co2')
      call put_names ('cfc', 'data/cfc')
      call put_names ('c14', 'data/c14')
      call put_names ('dc14', 'data/dc14')
      call put_names ('tidal', 'data/tidal')
      call put_names ('crops', 'data/crops')
      call put_names ('ice', 'data/ice')
      call put_names ('slh_ref', 'data/slh_ref')
      call put_names ('diff', 'data/diff')
      call put_names ('temperature_', 'data/temperature_')
      call put_names ('salinity_', 'data/salinity_')
      call put_names ('dtr_', 'data/dtr_')
      call put_names ('tco2_', 'data/tco2_')
      call put_names ('phosphate_', 'data/phosphate_')
      call put_names ('alk_', 'data/alk_')
      call put_names ('nitrate_', 'data/nitrate_')
      call put_names ('oxygen_', 'data/oxygen_')
      call put_names ('bkgc14_', 'data/bkgc14_')
      call put_names ('odf', 'data/odf')
      ...
      call put_names ('ts_intgrls', 'tsi')
      call put_names ('volc', 'data/volc')
      call put_names ('sulph', 'data/sulph')
      call put_names ('agg', 'data/agg')
      call put_names ('sat_avg', 'data/sat_avg')
      call put_names ('icedata', 'data/icedata')
      call put_names ('sealev', 'data/sealev')
      call put_names ('caco3', 'data/caco3')
      call put_names ('uvic_bias', 'data/uvic_bias')
