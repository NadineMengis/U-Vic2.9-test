! source file: /net/mare/home1/eby/as/updates/cembm.h
...
!     dtbar        = global average sat anomoly (C)
      ...
      real soilmax, eslnd, pass, pcfactor, rf1, rf2
      real sice_calb, gice_calb, csno_calb, wsno_calb, utlim, ltlim
      ...
      common /cembm_r/ eslnd, pass, pcfactor, rf1
      ...
      common /cembm_r/ sice_calb, gice_calb, csno_calb, wsno_calb
      common /cembm_r/ utlim, ltlim     , adiff, dtbar
...
!     tai_inswr     = net absorbed shortwave radiation
...
!     tai_catm      = average total carbon in atmosphere
      ...
      real tai_oprecip, tai_levap, tai_oevap, tai_solins, tai_outlwr
      real tai_dnswr, tai_inswr, tai_netrad, tai_palb, tai_aalb
      real tai_salb, tai_lsalb, tai_osalb, tai_sst, tai_sss, tai_ssdic
      real tai_ssc14, tai_ssalk, tai_sso2, tai_sspo4, tai_ssno3
      real tai_sscfc11, tai_sscfc12, tai_sulph, tai_volc, tai_agg
      real tai_catm
      ...
      common /cembm_r/ tai_outlwr, tai_dnswr, tai_inswr, tai_netrad
      common /cembm_r/ tai_palb, tai_aalb, tai_salb, tai_lsalb
      common /cembm_r/ tai_osalb, tai_sst, tai_sss, tai_ssdic
      common /cembm_r/ tai_ssc14, tai_ssalk, tai_sso2, tai_sspo4
      common /cembm_r/ tai_ssno3, tai_sscfc11, tai_sscfc12, tai_sulph
      common /cembm_r/ tai_volc, tai_agg, tai_catm
