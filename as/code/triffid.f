! source file: /net/mare/home1/eby/as/2.9.old3/source/mtlm/triffid.F
...
!             (/timestep).
! DFAB      = WORK areal fraction from agriculture that is burnt.
!             (/timestep).
      ...
      real DFRAC_AGR(POINTS,NPFT), DFAB
