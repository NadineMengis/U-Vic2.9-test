! source file: /net/mare/home1/eby/as/2.9.old3/source/mom/isopyc.F
...
!-----------------------------------------------------------------------
      ...
      if (exists) then
        ...
        exists = inqvardef('odf', iou)
        if (exists) then
          write(*,*) "reading ocean diffusion factor from: ",fname
          call getvara ('odf', iou, imtm2*jmtm2*km, ib, ic, tmpijk
     &,     c1, c0)
